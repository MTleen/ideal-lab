...
[![Plugins](https://img.shields.io/badge/plugins-11-blue?style=flat-square)](./plugins)
[![Skills](https://img.shields.io/badge/skills-47-green?style=flat-square)](./plugins)
...
目前包含 **11 个插件**、**47 个 Skill**，覆盖从需求到交付的完整链路。
