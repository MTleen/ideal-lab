...
[![Plugins](https://img.shields.io/badge/plugins-13-blue?style=flat-square)](./plugins)
...
目前包含 **13 个插件**、**48 个 Skill**，覆盖从需求到交付的完整链路。
...
| 插件 | 版本 | 说明 | Skills |
|------|------|------|--------|
| [ideal-dev-workflow](./plugins/ideal-dev-workflow) | 2.0.0 | 15 阶段开发流程：需求 → 方案 → 计划 → 编码 → 测试 → 评审 → 交付 | 14 |
...
| 插件 | 版本 | 说明 |
|------|------|------|
| [ideal-ralph](./plugins/ideal-ralph) | 0.6.0 | 苏格拉底式任务澄清 + 持久化小步迭代验证循环 |
...
| 插件 | 版本 | 说明 |
|------|------|------|
| [skill-builder](./plugins/skill-builder) | 1.1.0 | Skill 全生命周期引擎：从零创建或爬山优化，7 维度评估 + 棘轮机制 |
